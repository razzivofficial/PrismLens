    ...
    <%@ page contentType="text/html;charset=UTF-8" %>
        ...
        <head>
            ...
            <style>
                ...
                .bttnx-3:hover {
                    ...
                    background: linear-gradient(rgb(145, 232, 232),
                            rgb(25, 161, 210),
                            rgb(25, 161, 210),
                            rgb(145, 232, 232));
                    box-shadow: 0 0 10px black;
        ...
        <body>
                            ...
                            <li class="sidemenu">
                                <div class="dropdown">
                                    <button class="btn btn-secondary dropdown-toggle" type="button"
                                        ...
                                        aria-expanded="false" onclick="toggle(this)">Mens</button>
            ...
            <div class='cart-view-uper-uper'>
                ...
                <% // Database connection parameters for cart String cartJdbcUrl="jdbc:oracle:thin:@localhost:1521:xe" ;
                    String cartUsername="system" ; String cartPassword="admin" ; // JDBC connections for cart Connection
                    cartConnection=null; PreparedStatement cartPreparedStatement=null; ResultSet cartResultSet=null; try
                    { // Load the JDBC driver for cart Class.forName("oracle.jdbc.driver.OracleDriver"); // Establish
                    the connection for cart cartConnection=DriverManager.getConnection(cartJdbcUrl, cartUsername,
                    cartPassword); // Create a prepared statement for fetching data from the cart table String
                    cartQuery="SELECT * FROM cart WHERE email = ?" ;
                    cartPreparedStatement=cartConnection.prepareStatement(cartQuery); String userEmail=(String)
                    session.getAttribute("email"); // Retrieve user email from the session if (userEmail !=null &&
                    !userEmail.isEmpty()) { cartPreparedStatement.setString(1, userEmail);
                    cartResultSet=cartPreparedStatement.executeQuery(); boolean cartIsEmpty=true; // Display cart items
                    while (cartResultSet.next()) { String
                    productDescription=cartResultSet.getString("product_description"); double
                    productPrice=cartResultSet.getDouble("product_price"); String
                    productImageLink=cartResultSet.getString("product_image_link"); // Display cart item information
                    ...
                    out.println("<div class='cart-view-con'>");
                        ...
                        out.println("<div class='button-container'>");
                            out.println("<form action='placeOrder.jsp' method='post'>");
                                out.println("<input type='hidden' name='productDescription'
                                    value='" + productDescription + "'>");
                                out.println("<input type='hidden' name='productPrice' value='" + productPrice + "'>");
                                out.println("<input type='hidden' name='productImageLink'
            ...
            if (cartIsEmpty) {
            out.println("<u>
                <p class='hello-hello-hello-hello'>Your cart is empty!</p>
            </u>");
